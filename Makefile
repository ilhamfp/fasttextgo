...
OBJS = args.o matrix.o dictionary.o loss.o productquantizer.o densematrix.o quantmatrix.o vector.o model.o utils.o meter.o fasttext.o fasttext_wrapper.o
INCLUDES = -I.
...
clean:
	rm -rf *.o libfasttext.a *.o *.gcno *.gcda fasttext
